...
<html>
    ...
    <body>
        ...
        <img rel="stylesheet" href="img/red-and-white-tablecloth-pattern.jpg">
        
        <div id="wrapper">
              
            
            <div id="ruta">
            <h1>Hej Välkommen till Peppes <span title="Slynor">Pizza</span>, vi säljer <span title="påtända">påvärmda</span> <span title="prostituerade">Langos</span>!</h1>
            <h6>OBS! Inga pizzor...</h6>
            <img src="http://mia-mia.com/2/Stationerys/Animerade/Animerade11/Pizzabagare.gif" alt="#" title="Don Peppé, världens största pimp">
            <?php
            echo "<br />";
            echo "<table border='1'>";
            ...
            echo "<table id='update'>";
                echo "<form method='POST'>";
                    ...
                    echo "<br />";
                    echo "<input type='text' value='namn' name='namn'>";
                    echo "<br />";
                    echo "<input type='text' value='topping' name='topping'>";
                    echo "<br />";
                    echo "<input type='text' value='pris' name='pris'>";
                    echo "<br />";
